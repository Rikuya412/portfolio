...
serviceAnimation
.from(".service .bg-video", { autoAlpha: 0, duration: 1.0 })
.from(".service .bg-color", { autoAlpha: 0, yPercent: 100, transformOrigin: "center bottom" }, "<=1")
.from(".service .back p", { autoAlpha: 0, y: -100 }, "<=0.1")
.from(".service .container .mark-wrapper ul li", { autoAlpha: 0, y: 100, stagger: 0.2 }, "<")
.add(splitAndAnimate(".service .container .text h2", 0.04), "<")
.add(splitAndAnimate(".service .container .text .sentence", 0.01), "<=0.15")
...
worksAnimation
  ...
  .from(".works .title h3", { autoAlpha: 0, y:-50 },"-=1.0")
  .from(".works .title h2", { autoAlpha: 0, y:50 },"-=0.8")
  .from(".splide-main", { autoAlpha: 0, y:100, duration:1.5 },"-=0.5")
  .from(".splide-secondary", { autoAlpha: 0, y:100, duration:1.5 },"-=1.2");
...
meritBoxes.forEach((target) => {
  const thumbElements = target.querySelectorAll(".thumb-wrapper .thumb, .thumb-wrapper .bg-video");
